...
Additionally, there are roughly 4900\ednote{
    Includes 440 from UPS, which seems unannotated...
    Excludes talks as well...
    Other issues?
...
\ednote{rework this paragraph a bit -- make it contribution and overview at the same time?}
