...
especially after the verbalizations covered by the existing content commons\ednote{better
  to speak of the domain model here?} -- is geared towards adding to the content commons. 

This is complementary to the \srf approach,
